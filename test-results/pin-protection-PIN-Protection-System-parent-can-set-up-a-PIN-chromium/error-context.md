...
- Name: PIN Protection System >> parent can set up a PIN
- Location: /Users/edward/Desktop/Projects/Kiddo_Quest/kiddo-quest/tests/pin-protection.spec.js:6:3
...
Call log:
  - waiting for locator('button').filter({ hasText: 'Sign In' })
    ...
    at /Users/edward/Desktop/Projects/Kiddo_Quest/kiddo-quest/tests/pin-protection.spec.js:15:58
```
