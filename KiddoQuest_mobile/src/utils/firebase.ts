...
if (Platform.OS === 'web') {
  ...
  const firebaseConfig = {
    apiKey: process.env.EXPO_PUBLIC_FIREBASE_API_KEY || "AIzaSyBPcxz0AXwkNdmgfCvXwv8qz0vJ_ijX7FY",
    authDomain: process.env.EXPO_PUBLIC_FIREBASE_AUTH_DOMAIN || "kiddo-quest-de7b0.firebaseapp.com",
    projectId: process.env.EXPO_PUBLIC_FIREBASE_PROJECT_ID || "kiddo-quest-de7b0",
    storageBucket: process.env.EXPO_PUBLIC_FIREBASE_STORAGE_BUCKET || "kiddo-quest-de7b0.appspot.com",
    messagingSenderId: process.env.EXPO_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || "303359892497",
    appId: process.env.EXPO_PUBLIC_FIREBASE_APP_ID || "1:303359892497:web:8ff4db457c6838fbe155c5"
  };
