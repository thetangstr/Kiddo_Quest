...
- Name: Recurring Quest Enhancements >> parent can create a recurring quest with penalty points
- Location: /Users/edward/Desktop/Projects/Kiddo_Quest/kiddo-quest/tests/recurring-quest-features.spec.js:6:3
...
Call log:
  - waiting for locator('button').filter({ hasText: 'Sign In' })
    ...
    at /Users/edward/Desktop/Projects/Kiddo_Quest/kiddo-quest/tests/recurring-quest-features.spec.js:15:58
```
