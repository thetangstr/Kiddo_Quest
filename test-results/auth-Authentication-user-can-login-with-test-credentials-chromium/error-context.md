...
- Name: Authentication >> user can login with test credentials
- Location: /Users/edward/Desktop/Projects/Kiddo_Quest/kiddo-quest/tests/auth.spec.js:35:3
...
Call log:
  - waiting for locator('button').filter({ hasText: 'Sign In' })
    ...
    at /Users/edward/Desktop/Projects/Kiddo_Quest/kiddo-quest/tests/auth.spec.js:46:58
```
